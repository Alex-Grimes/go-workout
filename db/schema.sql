...
CREATE INDEX FK_67 ON gowebapp.images ( User_ID );
...
CREATE INDEX
    FK_108 ON gowebapp.sets (Exercise_ID);
...
CREATE TABLE
    gowebapp.workouts (
        ...
        CONSTRAINT PK_workouts PRIMARY KEY (
            Workout_ID,
            Set_ID,
            User_ID,
            Exercise_ID
...
CREATE INDEX
    FK_73 ON gowebapp.workouts (Set_ID, Exercise_ID);

CREATE INDEX FK_76 ON gowebapp.workouts ( User_ID );